...
namespace BillingSystem
{
    public class MOC : IChargeable, IPrintable, IRequiredNumbers
    {
        ...
        public override string ToString()
        {
            ...
            return string.Format("Call Start time: {0,25} Call Duration: {1} s Location network: {2} BParty: {3}", 
                this.CallStartTime, this.CallDuration, this.CurrentLocation, this.BParty);
        }
